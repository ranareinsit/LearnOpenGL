...
void renderScene(const Shader &shader) {
    ...
    model           = glm::rotate(model, glm::radians(-5.0f), glm::normalize(glm::vec3(1.0, 0.0, 0.0)));
...
int main() {
    ...
    SDL_Window *window =
        SDL_CreateWindow("5-advanced_lighting/3-1-1-shadow_mapping_depth", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    float planeVertices[] = {
        ...
        25.0f, -0.5f, 25.0f, 0.0f,   1.0f,  0.0f,   25.0f, 0.0f, -25.0f, -0.5f, 25.0f,  0.0f, 1.0f,
        0.0f,  0.0f,  0.0f,  -25.0f, -0.5f, -25.0f, 0.0f,  1.0f, 0.0f,   0.0f,  25.0f,

        25.0f, -0.5f, 25.0f, 0.0f,   1.0f,  0.0f,   25.0f, 0.0f, -25.0f, -0.5f, -25.0f, 0.0f, 1.0f,
        0.0f,  0.0f,  25.0f, 25.0f,  -0.5f, -25.0f, 0.0f,  1.0f, 0.0f,   25.0f, 25.0f
