...
int main() {
    ...
    SDL_Window   *window = SDL_CreateWindow("5-advanced_lighting/2-gamma_correction", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    unsigned int floorTextureGammaCorrected = loadTexture("../../resources/textures/wood.png");
