...
int main() {
    ...
    SDL_Window   *window  = SDL_CreateWindow("5-advanced_lighting/6-hdr", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    while (run) {
        ...
        if (keys[SDL_SCANCODE_SPACE] && !hdrKeyPressed) {
            hdr           = !hdr;
            hdrKeyPressed = true;
        }
