...
bool BloomRenderer::Init(unsigned int windowWidth, unsigned int windowHeight) {
    ...
    // Shaders
    mDownsampleShader = new Shader("6.new_downsample.vs", "6.new_downsample.fs", nullptr, nullptr, nullptr);
    mUpsampleShader   = new Shader("6.new_upsample.vs", "6.new_upsample.fs", nullptr, nullptr, nullptr);
...
int main() {
    ...
    SDL_Window   *window  = SDL_CreateWindow("8-guest/2022/6-physically_based_bloom", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL);
    ...
    // -------------------------
    Shader shader("6.bloom.vs", "6.bloom.fs", nullptr, nullptr, nullptr);
    Shader shaderLight("6.bloom.vs", "6.light_box.fs", nullptr, nullptr, nullptr);
    Shader shaderBlur("6.old_blur.vs", "6.old_blur.fs", nullptr, nullptr, nullptr);
    Shader shaderBloomFinal("6.bloom_final.vs", "6.bloom_final.fs", nullptr, nullptr, nullptr);
