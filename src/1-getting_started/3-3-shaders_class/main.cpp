...
int main() {
    ...
    SDL_Window   *window  = SDL_CreateWindow("3.3.shaders_class", window_width, window_height, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    GLuint ourShader = createShader("3.3.shader.vs", "3.3.shader.fs");
