...
int main() {
    ...
    SDL_Window   *window  = SDL_CreateWindow("7.6.camera_exercise2", window_width, window_height, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    while (run) {
        ...
        float     radius = 10.0f;
        float     camX   = static_cast<float>(sin(delta) * radius);
        float     camZ   = static_cast<float>(cos(delta) * radius);
