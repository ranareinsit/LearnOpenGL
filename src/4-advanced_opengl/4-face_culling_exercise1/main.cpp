...
int main() {
    ...
    SDL_Window *window =
        SDL_CreateWindow("4-advanced_opengl/4-face_culling_exercise1", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    glEnable(GL_CULL_FACE); // <<< E N A B L E
    glCullFace(GL_CW);
    ...
    // --------------------------------
    vector<glm::vec3> windows{glm::vec3(-1.5f, 0.0f, -0.48f), glm::vec3(1.5f, 0.0f, 0.51f), glm::vec3(0.0f, 0.0f, 0.7f), glm::vec3(-0.3f, 0.0f, -2.3f),
