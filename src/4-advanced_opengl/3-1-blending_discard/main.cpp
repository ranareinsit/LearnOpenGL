...
int main() {
    ...
    SDL_Window   *window = SDL_CreateWindow("4-advanced_opengl/3-1-blending_discard", SCR_WIDTH, SCR_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_HIGH_PIXEL_DENSITY);
    ...
    // --------------------------------
    vector<glm::vec3> vegetation{glm::vec3(-1.5f, 0.0f, -0.48f), glm::vec3(1.5f, 0.0f, 0.51f), glm::vec3(0.0f, 0.0f, 0.7f), glm::vec3(-0.3f, 0.0f, -2.3f),
